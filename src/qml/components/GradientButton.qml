...
Controls.Button {
    ...
    background: Rectangle {
        ...
        color: root.useGradient ? "transparent" : (root.hovered ? Qt.darker(root.cPrimary, 1.1) : root.cPrimary)
        ...
        Rectangle {
            ...
            SequentialAnimation on _shimmer.pos {
                running: root.hovered; loops: Animation.Infinite
                NumberAnimation { from: -0.3; to: 1.3; duration: 2000 }
            }
        }
    }
